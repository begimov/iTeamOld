...
@section('header')
    ...
    <header id="top" class="header">
        <div class="text-vertical-center">
            <h1><span class="autoZoom">Русский Менеджмент</span></h1>
            <h3>
				<span class="autoZoom">
					<b style="">Как сделать компанию управляемой и эффективной</b>
				</span>
			</h3>
            <br>
			...
			@if(!$user)
				...
				<a class="btn btn-light btn-lg" role="button" data-toggle="modal" data-target="#welcomeModal" href="#welcomeModal">Войти</a>
				
			@else
				
				<a href="/i" class="btn btn-light btn-lg">В Личный кабинет</a>
...
@section('main')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <p class="lead">Обучение, коучинг, консультирование собственников и руководителей компаний</p>
                </div>
            </div>
            <!-- /.row -->
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <div class="service-item">
                                ...
                                <p>Мастер-классы и мастер-проекты по управлению от бизнес-практиков, представляющие целостную систему знаний о менеджменте</p>
                                <a href="/learn" class="btn btn-light">Каталог программ</a>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6">
                                                        <div class="service-item">
                                ...
                                <p>Индивидуальное обучение и консалтинг собственников и руководителей, управленческий аудит компаний</p>
                                <a href="/company/service" class="btn btn-light">Список услуг</a>
                            </div>
                        </div>
    ...
    <aside class="aside callout">
        <div class="text-vertical-center">
			...
			<br>
			<p>
				<a href="/company/projects" class="btn btn-light">Проекты</a>
				<a href="/responses" class="btn btn-light">Отзывы</a>
			</p>
        </div>
    </aside>

    <!-- Portfolio -->
    <section id="portfolio" class="section portfolio hidden">
        <div class="container">
            <div class="row">
    ...
    <!-- Call to Action -->
    <aside class="aside call-to-action bg-primary hidden">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
...
@section('footer')
		<a href="#next" id="nextDown"><span class="glyphicon glyphicon-chevron-down" aria-hidden="true"></span></a>
		@include('c.modals.welcome')
@stop
