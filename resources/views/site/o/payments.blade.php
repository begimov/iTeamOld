<div class="row">
	...
	<div class="col-lg-6">
		<div class="list-group">
			<label href="#" class="payment-change label-button list-group-item {{ ($order && $order->payment_type === 'ya_ac') ? 'active' : '' }}">
			...
			<label href="#" class="payment-change label-button list-group-item {{ ($order && $order->payment_type === 'ya_pc') ? 'active' : '' }}">
