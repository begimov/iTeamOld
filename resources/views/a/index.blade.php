...
@section('main')
    ...
    <div class="card">
        <div class="card-header">
            <h2>Статистика продаж
                <small>Продаж за выбранный период: <b>{{ @$count }}</b> на сумму: <b>{{ @$sum }}</b> руб.</small>
            </h2>
        ...
        <div class="card-body">
            <div class="chart-edge">
                <div id="curved-line-chart" class="flot-chart" data-data1="{{ @$data1 }}" data-data2="{{ @$data2 }}"
                     data-dates="{{ @$dates }}"></div>
            </div>
        </div>
    </div>
