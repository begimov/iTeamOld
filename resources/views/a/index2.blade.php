...
@section('main')
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h2>Статистика продаж <small>Продаж за выбранный период: <b>{{ @$count }}</b> на сумму: <b>{{ @$sum }}</b> руб.</small></h2>
									...
									<div class="dropdown-menu dropdown-menu-lg pull-right">
										<div class="listview">
											...
											<div class="lv-body">
													...
													<div class="col-sm-8">
														<p class="c-black f-500 m-b-20">От</p>
													...
													<div class="col-sm-8">
														<p class="c-black f-500 m-b-20">До</p>
                        ...
                        <div class="card-body">
                            <div class="chart-edge">
                                <div id="curved-line-chart" class="flot-chart" data-data1="{{ @$data1 }}" data-data2="{{ @$data2 }}" data-dates="{{ @$dates }}"></div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div id="best-selling" class="dash-widget-item">
                                    <div class="dash-widget-header">
                                        ...
                                        <img src="/a/img/widgets/alpha.jpg" alt="">
                                        <div class="main-item">
                                    ...
                                    <div class="listview p-t-5">
                                        <a class="lv-item" href="">
                                            <div class="media">
                                                <div class="pull-left">
                                                    <img class="lv-img-sm" src="/a/img/widgets/note4.jpg" alt="">
                                                </div>
                                        ...
                                        <a class="lv-item" href="">
                                            <div class="media">
                                                <div class="pull-left">
                                                    <img class="lv-img-sm" src="/a/img/widgets/mate7.jpg" alt="">
                                                </div>
                                                <div class="media-body">
                                        ...
                                        <a class="lv-item" href="">
                                            <div class="media">
                                                <div class="pull-left">
                                                    <img class="lv-img-sm" src="/a/img/widgets/535.jpg" alt="">
                                                </div>
                                                <div class="media-body">
                                ...
                                <div class="tl-body">
                                    <div id="add-tl-item">
                                        ...
                                        <div class="add-tl-body">
                                            <textarea placeholder="Какие планы?"></textarea>
    ...
    <button type="button" class="btn btn-primary btn-lg" data-target="#modal1" data-toggle="modal" data-src="/images/content/ru_manag.png">
      Launch demo modal
    </button>

    <!-- Modal -->
    <div class="modal fade" id="modal1" aria-labelledby="modalLabel" role="dialog" tabindex="-1">
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    ...
                    <div class="row">
						<div class="col-sm-6">
							<img class="cropper" src="/thema/Template/jquery/media/gallery/thumbs/10.jpg#/images/content/finance.png"/>
							<button type="button" class="btn btn-primary" id="getCroppedCanvas">
								Get
							</button>
                        </div>

						<div class="col-sm-6">
							<img id="cropper" src="/images/content/2_iz_lartsa.png" style="max-width:400px;"/>
                        </div>
                    </div>
					
					
					<!-- Show the cropped image in modal -->
					<div class="modal fade" id="getCroppedCanvasModal" aria-hidden="true" aria-labelledby="getCroppedCanvasTitle" role="dialog" tabindex="-1">
