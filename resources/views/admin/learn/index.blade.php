...
@section('main')
	...
	<div class="block-header">
		<h2><i class="zmdi zmdi-videocam"></i> {{ Request::input('parent_id') || Request::input('search') ? link_to_route('admin.learn.index','Мастер-проекты/Мастер-классы') : 'Мастер-проекты/Мастер-классы' }}</h2>
	</div>

	<div class="card">
		<div class="listview lv-bordered lv-lg">
			<div class="lv-header-alt clearfix">
				<h2 class="lvh-label hidden-xs"><i class="zmdi zmdi-videocam"></i> Мастер-проекты/Мастер-классы</h2>
				
				<form class="search">
				
				<div class="lvh-search">
					<input type="text" name="search" placeholder="Поиск по названию..." class="lvhs-input" value="{{ Request::input('search') ? Request::input('search') : '' }}" >
					...
					<li class="dropdown">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<select id="parent_id" name="parent_id" class="choselect" data-placeholder="Выберите категорию...">
								<option {{ null === Request::input('parent_id') || Request::input('parent_id')==="" ? 'selected' : '' }} title="Все" value="">Все разделы</option>
