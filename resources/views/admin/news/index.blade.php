...
@section('main')
	...
	<div class="block-header">
		<h2><i class="zmdi zmdi-flash"></i> {{ Request::input('search') ? link_to_route('admin.news.index','Новости') : 'Новости' }}</h2>
	</div>

	<div class="card">
		<div class="listview lv-bordered lv-lg">
			<div class="lv-header-alt clearfix">
				<h2 class="lvh-label hidden-xs"><i class="zmdi zmdi-flash"></i> Новости</h2>
