...
@section('main')
	...
	<div class="block-header">
		<h2><i class="zmdi zmdi-comment-alert"></i> {{ Request::input('search')!==null ? link_to_route('admin.response.index','Отзывы') : 'Отзывы' }}</h2>
	</div>

	<div class="card">
		<div class="listview lv-bordered lv-lg">
			<div class="lv-header-alt clearfix">
				<h2 class="lvh-label hidden-xs"><i class="zmdi zmdi-comment-alert"></i> Отзывы</h2>
				
				<form class="search">
				
				<div class="lvh-search">
					<input type="text" name="search" placeholder="Поиск по тексту отзыва или имени автора..." class="lvhs-input" value="{{ Request::input('search') ? Request::input('search') : '' }}" >
					...
					<li class="dropdown">
						...
						<div class="dropdown-menu dropdown-menu-right" style="padding:20px;min-width:320px;">
							...
							<div class="input-group">
								<div class="fg-line">
									<input type="text" class="form-control" name="learn" value="{{ Request::input('learn') ? Request::input('learn') : '' }}" placeholder="Мастер-проект/мастер-класс">
								</div>
