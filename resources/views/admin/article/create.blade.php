...
@section('main')
	...
	<div class="block-header">
		...
		<h2><i class="zmdi zmdi-edit"></i> {{ link_to_route('admin.article.index','Публикации') }} &rarr; Новая публикация</h2>
	...
	<div class="card">
		<div class="card-body card-padding">
			...
			<div role="tabpanel">
				...
				<!--@ yield('form')-->
				{!! Form::model($data, ['route' => 'admin.article.store', 'class' => '']) !!}
						...
						<div class="row">
							...
							<div class="col-sm-4 m-t-15">
								<div class="checkbox m-t-15">
									<label>
										<input type="checkbox" name="children" value="{{ $data->children || $data->childrens->count() ? "1" : "-1" }}">
