...
@section('main')
	...
	<div class="block-header">
		<h2><i class="zmdi zmdi-case-check"></i> {{ link_to_route('admin.project.index','Проекты') }} &rarr; {{ $project->company->company_name }}</h2>
	</div>
	...
	<div class="card">
		...
		<!--@ yield('form')-->
		{!! Form::model($project, ['route' => ['admin.project.update', $project->id], 'class' => '']) !!}
			...
			{!! Form::hidden('_method','PUT') !!}
				...
				<div class="row">
					...
					<div class="col-sm-6 text-center">
						<a class="btn btn-sm btn-success" href="{{ route('admin.company.edit', ['id'=>$project->company->id]) }}">Редактировать компанию</a>
					</div>
				</div>
				<br>
