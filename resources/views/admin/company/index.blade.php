...
@section('main')
	...
	<div class="block-header">
		<h2><i class="zmdi zmdi-store"></i> {{ Request::input('search') ? link_to_route('admin.company.index','Компании') : 'Компании' }}</h2>
	</div>

	<div class="card">
		<div class="listview lv-bordered lv-lg">
			<div class="lv-header-alt clearfix">
				<h2 class="lvh-label hidden-xs"><i class="zmdi zmdi-store"></i> Компании</h2>
