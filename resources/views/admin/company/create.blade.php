...
@section('main')
	...
	<div class="block-header">
		<h2><i class="zmdi zmdi-store"></i> {{ link_to_route('admin.company.index','Компании') }} &rarr; Новая компания</h2>
	</div>
	...
	<div class="card">
		<div class="card-body card-padding">
			...
			<!--@ yield('form')-->
			{!! Form::model($company, ['route' => ['admin.company.store'], 'class' => '', 'files' => 'true']) !!}
