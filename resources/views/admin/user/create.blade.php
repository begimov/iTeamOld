...
@section('main')
	...
	<div class="block-header">
		<h2><i class="zmdi zmdi-accounts-alt"></i> {{ link_to_route('admin.user.index','Пользователи') }} &rarr; Новый пользователь</h2>
	</div>
	...
	<div class="card">
		...
		<div class="card-body card-padding">
			<div class="row">
				...
				{!! Form::model($user, ['route' => ['admin.user.store'], 'class' => 'validate', 'files' => true]) !!}
					...
					<div class="col-lg-9 col-sm-9">
						<div class="row">
							<div class="col-lg-6 col-sm-6">
								...
								<hr>
								{!! Form::group('password', 'password', $errors, 'Создание пароля', null, 'lock', null, ['placeholder'=>'Пароль', 'minlength'=>6, 'maxlength'=>32, 'data-toggle'=>'tooltip', 'data-placement'=>'top', 'title'=>'Только латинские буквы, цифры или знаки _@#$%^&*-. От 6 до 32 символов']) !!}
									...
									<div class="fg-line">
										<div class="select">
											...
											<select class="form-control" name="role_id">
												<option {{ (!Request::input('role_id') || Request::input('role_id') > 2) ? 'selected' : '' }} value="3">Пользователь</option>
												<option {{ (@Request::input('role_id') === 2) ? 'selected' : '' }} value="2">Редактор</option>
												<option {{ (@Request::input('role_id') === 1) ? 'selected' : '' }} value="1">Администратор</option>
											</select>
										</div>
									</div>
								</div>
