...
@section('form')
    ...
    <div class="row">
        ...
        <!--p>{{ trans('front/register.infos') }}</p-->
            ...
            {!! Form::group('text', 'firstname', $errors, null, null, 'user', null, ['placeholder' => 'Имя', 'required'=>true, 'data-toggle'=>'tooltip', 'data-placement'=>'top', 'title'=>'Как к Вам обращаться?']) !!}
            ...
            <div>
                ...
                <p>Но Вы можете сразу их
                    <a class="link" role="button" data-toggle="collapse" href="#collapseExample" aria-expanded="false"
