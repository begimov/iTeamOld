...
<div class="row">
	...
	<div class="col-lg-10 col-lg-offset-1">
		<div id="pay_screen_ya_ka" class="row pay_screen payment_type-ya_ka" style="{{ (@$order && $order->payment_type &&  $order->payment_type==='ya_ka') ? 'display:block;' : 'display:none;' }}">
			<div class="row">
				<div class="col-lg-6 col-md-6">
					...
					<p>Вы будете перенаправлены на сайт Яндекс.Касса. На сайте будут предоставлены самые популярные электронные системы платежей.</p>
				</div>
				<div class="col-lg-6 col-md-6">
					...
					{{--<form method="POST" action="https://demomoney.yandex.ru/eshop.xml">--}}
						...
						<div class="form-group ">
							...
							<div class="input-group">
								...
								<input placeholder="Email" required="required" class="form-control" name="cps_email" type="email" value="{{ Request::input('email') ? Request::input('email') : $order->email }}" id="email">
							</div>
						</div>
						<div class="form-group ">
							...
							<div class="input-group">
								...
								<input placeholder="Телефон" required="required" class="form-control" name="cps_phone" type="text" value="{{ Request::input('phone') ? Request::input('phone') : (@$order->phone ? $order->phone : @$order->user->phone) }}" id="phone">
							</div>
						</div>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6">
					<form method="POST" class="ajax-update-order-yandex" action="https://money.yandex.ru/quickpay/confirm.xml">
						...
						<input type="hidden" name="formcomment" value="Мастер-проекты iTeam">
		...
		<div id="pay_screen_walletone" class="row pay_screen payment_type-walletone" style="{{ (@$order && $order->payment_type &&  $order->payment_type==='walletone') ? 'display:block;' : 'display:none;' }}">
			<div class="row">
				<div class="col-lg-6 col-md-6">
					<p class="lead">Способ оплаты: <b>{{ HTML::paymentTypeText('walletone') }}</b></p>
					<p>Вы будете перенаправлены на сайт "Единой кассы". На сайте будут предоставлены самые популярные электронные системы платежей.</p>
				</div>
				<div class="col-lg-6 col-md-6">
					<div class="form-group ">
						<label for="name" class="control-label">Ваше имя</label>
