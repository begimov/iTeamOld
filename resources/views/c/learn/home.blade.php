...
@section('header')
    ...
    <header class="learn-header">
		...
		<div style="width:100%; background-color:#6A0101; color:#fff;padding:1em;">
		    <h1 class="learn-header-title" style="margin-top:-1em;"><img  src="/filemanager/userfiles/user0/icons/title-mk.png"  /> Мастер-классы / Мастер-проекты / Кейсы</h1>
		    </div>
		<br/>
...
<table style="width:50%;margin:0 auto;">
    <tr>
        <td><a href="https://iteam.ru/learn/webinar"><img  src="/filemanager/userfiles/user0/icons/book/webinar-icon.png" /></a></td>
        <td><a href="https://iteam.ru/learn/course"><img  src="/filemanager/userfiles/user0/icons/book/course-icon.png" /></a></td>
        <td><a href="https://iteam.ru/learn/breakfast"><img  src="/filemanager/userfiles/user0/icons/book/coffee-cup.png" /></a></td>
    </tr>
        <tr>
        <td><a style="color:#333333;font-weight:bold;" href="https://iteam.ru/learn/webinar">МАСТЕР-КЛАССЫ</a></td>
        <td><a style="color:#333333;font-weight:bold;" href="https://iteam.ru/learn/course">МАСТЕР-ПРОЕКТЫ</a></td>
        <td><a style="color:#333333;font-weight:bold;" href="https://iteam.ru/learn/breakfast">КЕЙСЫ</a></td>
    </tr>
</table>
</div>
				...
				<div class="col-lg-10 col-lg-offset-1">
					...
					<div class="media">
						...
						<div class="media-body">
						   <h4 class="media-heading" style="width:100%; background-color:#ddd; padding:20px;border-radius:7px;margin:0;">
						       <img class="pics-mk"  src="/filemanager/userfiles/user0/content/title-mk1-small.png" style="border-right:2px solid #666; padding-right:20px;margin-right:20px;" />
