			...
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="row vertical-align">
						...
						<div class="col-md-8">
							<!-- LINK -->
							<h3><a href="https://iteam.ru/landing/template/mp-upravlenie-nalogovymi-riskami-companii.html">УПРАВЛЕНИЕ НАЛОГОВЫМИ РИСКАМИ КОМПАНИИ</a></h3>
							<p>
							    <strong>Результат мастер-проекта</strong>&nbsp;&mdash; выстроенная налоговая политика, которая обеспечивает полную безопасность и&nbsp;защищенность компании.
							    <ul>
							        <li>Будем комплексно анализировать, строить и&nbsp;корректировать вашу налоговую политику на&nbsp;основе стратегии компании на&nbsp;ближайшие 2-3&nbsp;года, учитывая дорожную карту налоговых изменений Федеральной налоговой службы до&nbsp;2020&nbsp;года.</li>
							        <li>Протестируем применяемые вами схемы, найдем все налоговые риски, рассчитаем налоговую нагрузку и&nbsp;законные способы ее&nbsp;снижения.</li>
							        <li>Разработаем планы организационных, юридических и&nbsp;иных изменений в&nbsp;вашей компании.</li>
							        <li>Установим маркеры дестабилизации налоговой нагрузки и&nbsp;меры реагирования для нейтрализации неблагоприятных налоговых последствий.</li>
							    </ul>
							</p>
						</div>
						<div class="col-md-2 text-center">
							<h3>30&thinsp;000&nbsp;&#8381;</h3>
							<!-- LINK -->
							<a href="https://iteam.ru/landing/template/mp-upravlenie-nalogovymi-riskami-companii.html"><button class="btn btn-danger">Подробнее</button></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="row vertical-align">
						...
						<div class="col-md-8">
							<!-- LINK -->
							<h3><a href="https://iteam.ru/landing/template/sozdanie-sistemy-fin-ucheta.html">СОЗДАНИЕ СИСТЕМЫ УПРАВЛЕНЧЕСКОГО ФИНАНСОВОГО УЧЕТА</a></h3>
							<p>
							    <ul>
							        <li>12 этапов, 6 месяцев</li>
							        <li>47 готовых для внедрения шаблонов на каждый этап</li>
							        <li>результат: вы внедрите правильную систему управленческого финансового учета, которая на 100% выполняет свои функции</li>
							    </ul>
							</p>
						</div>
						<div class="col-md-2 text-center">
							<h3>40&thinsp;000&nbsp;&#8381;</h3>
							<!-- LINK -->
							<a href="https://iteam.ru/landing/template/sozdanie-sistemy-fin-ucheta.html"><button class="btn btn-danger">Подробнее</button></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="panel-body">
					<div class="row vertical-align">
						...
						<div class="col-md-8">
							...
							<p>
								Готовые планы и&nbsp;бюджеты на 2018 год за&nbsp;2&nbsp;месяца.</a>
							</p>
						</div>
						<div class="col-md-2 text-center">
							<h3>40&thinsp;000&nbsp;&#8381;</h3>
