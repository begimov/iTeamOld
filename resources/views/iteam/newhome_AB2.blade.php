@extends('iteam.newtemplate_no_fb_AB2')
		    ...
		    <div class="modal-content">
		        ...
		        <div class="row vertical-align">
                  <div class="col-md-6 col-sm-6 magnet-block">
                      <img src="img/home_magnet_img.png" class="img-responsive pull-right" width="55%">
                  </div>
                  <div class="col-md-6 col-sm-6">
                    <h3><strong>Вам подарок!</strong></h3>
                    <h5>КНИГА &laquo;Как внедрить бизнес-процессы&raquo;!</h5>
                    <!-- <div class="row">
                        <div class="col-md-7 col-sm-9 col-xs-11" style="margin: 10px 0 20px 0;">
                        <form action="/grform" method="get" id="grForm">
                            ...
                            <input type="hidden" name="campaign_token" value="nG21S" />
                    ...
                    <div style="float:left; margin-top:10px;">
                        <script type="text/javascript" src="https://app.getresponse.com/view_webform_v2.js?u=Bh5z&webforms_id=6254006"></script>
                    </div>
                  </div>
                </div>
		        </div>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				...
				span.onclick = function() {
					...
					//document.getElementById('magnet-block1').style.display = "block";
					//document.getElementById('magnet-block2').style.display = "block";
				}
