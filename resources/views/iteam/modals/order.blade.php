		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<ul id="paymentTabs" class="nav nav-tabs nav-justified" role="tablist">
					...
					@if(isset($order))
						<li role="presentation" class=""><a href="#checkout" aria-controls="checkout" role="tab" data-toggle="tab">Подтверждение</a></li>
					@endif
				</ul>
				...
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane active" id="payment_method">
						@include('iteam.modals.payments')
					</div>
					
					<div role="tabpanel" class="tab-pane" id="checkout">
						@if(isset($order))
						@include('iteam.modals.confirms')
						@endif
					</div>
