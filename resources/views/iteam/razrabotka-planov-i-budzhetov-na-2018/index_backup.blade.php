...
<div class="container">
    ...
    <div style="text-align: right">
        <h2>
            <strong style="color: #870100;">Разработка планов и&nbsp;бюджетов компании на&nbsp;2018 год</strong>
        </h2>
    ...
    <div class="row">
        <div class="col-md-5">
            <img class="img-responsive img-rounded" src="https://iteam.ru/landing/img/Управление проектами (14).png"
                 style="max-width: 70%">
        </div>
        <div class="col-md-7">
            {{--<img class="img-responsive img-rounded" src="https://iteam.ru/landing/img/YouTube.png"--}}
                 {{--style="max-width: 100%">--}}
            <iframe width="640" height="480" src="https://www.youtube.com/embed/cv0Xl2AVK4Y" frameborder="0" allowfullscreen></iframe>
        </div>
    </div>
    <hr>
    @if ($errors->any())
    ...
    <div class="row text-center">
        <div class="col-md-12">
            <p><a href="#" class="modal2 btn btn-danger btn-lg">СКАЧАТЬ ПРЕЗЕНТАЦИЮ</a></p>
        </div>
    </div>
    <div class="row">
        <div id="modal_form">
