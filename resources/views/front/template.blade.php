...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <body>
	...
	<header id="header" style="">
		...
		@else
			<a class="head_logo" href="/" title="{{ trans('front/site.title') }} {{ trans('front/site.sub-title') }}">
			{{ trans('front/site.title') }}
			</a>
		@endif
		</div>
		<div class="nav" style="display:none;">
			<input class="sandwich_check" id="sandwich_menu" name="sandwich_menu" type="checkbox">
			<label for="sandwich_menu" class="sandwich_icon">☰</label>
			<div class="menu">
				<ul>
					...
					<li {!! classActiveSegment(1, ['articles', 'blog']) !!}>
						{!! link_to('blog', trans('front/site.blog')) !!}
					</li>
	...
	<footer role="contentinfo">
		 @yield('footer')
		<p class="text-center"><small>&copy; 2002 - {{ date('Y') }} {{ trans('front/site.title') }}</small></p>
	</footer>
